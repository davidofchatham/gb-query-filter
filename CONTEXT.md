...
**Automated coverage exists for the targeting rule only:** the `query-filters` fixture blueprint at [tools/fixtures/query-filters/](tools/fixtures/query-filters/) — see its README. Everything else is manual.
